...
public class QuestionDosenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_dosen);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Question> options =
                new FirebaseRecyclerOptions.Builder<Question>()
                        .setQuery(questionListRef.child("dosen view")
            ...
            protected void onBindViewHolder(@NonNull QuestionViewHolder holder, int position, @NonNull final Question model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(QuestionDosenActivity.this);
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (i == 0){
                                    Intent intent = new Intent(QuestionDosenActivity.this, QuestionDosenDetailActivity.class);
                                    intent.putExtra("qid", model.getQid());
                                    startActivity(intent);
                                }
                                if (i ==1 ){
                                    questionListRef.child("dosen view").child(Prevalent.currentOnlineUser.getNim())
                                            .child("Question").child(model.getQid()).removeValue()
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        Toast.makeText(QuestionDosenActivity.this, "Question removed successfully", Toast.LENGTH_SHORT).show();

                                                        Intent intent = new Intent(QuestionDosenActivity.this, MainDosenActivity.class);
                                                        startActivity(intent);
                                                    }
                                                }
                                            });
