...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(EditProfileActivity.this,ProfileActivity.class);
                startActivity(a);
            }
        });
    ...
    private void userInfoDisplay(final CircleImageView imageUser, final EditText editName, final EditText editPassword) {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.currentOnlineUser.getNim());
    ...
    private void uploadImage()
    {
        ...
        Paper.book().write(Prevalent.UserNimKey, editName);
        Paper.book().write(Prevalent.UserPasswordKey, editPassword);
    }
